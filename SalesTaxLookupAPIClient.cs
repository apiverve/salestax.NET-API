...
namespace APIVerve
{
    public class SalesTaxLookupAPIClient
    {
        ...
        public SalesTaxLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public SalesTaxLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, salestaxQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(salestaxQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(salestaxQueryOptions options)
        {
